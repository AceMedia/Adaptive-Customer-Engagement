	...
	public static function defaults(): array {
		return array(
			...
			'ai_agent'       => array(
				...
				'system_prompt'              => 'You are the company and product assistant. Answer clearly and helpfully using the current company and product information when it is available. If the answer is not clear from the available context, say so plainly rather than guessing.',
